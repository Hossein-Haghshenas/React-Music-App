function MusicPlayer() {
  return (
    <section
      className="musicPlayer flex flex-col px-5 py-3 mt-5 w-[100%] border-2 rounded-2xl
     border-black  bg-[#232a4e]"
    >
      {/* Upper Part */}
      <section className="upperPart flex items-center justify-between">
        {/* profile */}
        <section className="profile flex">
          <img
            src={require("../image/Mask Group 23.png")}
            alt=""
            className="w-[2.5rem] h-[2.5rem] border-2 border-white rounded-full"
          />
          <section className="details flex flex-col ml-4">
      ...
      {/* Lower Part */}
      <section className="lowerPart flex items-center justify-between py-[1rem] mt-[1rem]">
        <section className="track flex items-center justify-between text-sm text-gray-500 flex-[2]">
          <span>2:30</span>
          <img
